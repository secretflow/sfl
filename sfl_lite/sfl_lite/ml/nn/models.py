...
class AlexNet(nnx.Module):
    ...
    def __init__(self, num_classes: int = 10, *, rngs: nnx.Rngs):
        self.conv1 = nnx.Conv(3, 96, (11, 11), strides=(4, 4), padding=((9, 9), (9, 9)), rngs=rngs)
...
class MLP2Layer(nnx.Module):
    ...
    def __init__(self, input_dim: int = 784, hidden_dim: int = 128, num_classes: int = 10, *, rngs: nnx.Rngs):
...
class MLP3Layer(nnx.Module):
    ...
    def __init__(self, input_dim: int = 784, hidden_dims: Tuple[int, int] = (256, 128), num_classes: int = 10, *, rngs: nnx.Rngs):
